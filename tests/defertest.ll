...
@"$string2" = private unnamed_addr constant [3 x i8] c"%d\00"
@"$string6" = private unnamed_addr constant [4 x i8] c"%d\0A\00"
@str = private unnamed_addr constant [3 x i8] c"ay\00"
@str7 = private unnamed_addr constant [3 x i8] c"no\00"
@str9 = private unnamed_addr constant [4 x i8] c"lol\00"

; Function Attrs: nounwind
define i32 @main() #0 {
entry:
  %x = alloca i32, align 4
  %0 = call i32 (i8*, i32*, ...)* bitcast (i32 (i8*, ...)* @scanf to i32 (i8*, i32*, ...)*)(i8* getelementptr inbounds ([3 x i8]* @"$string2", i64 0, i64 0), i32* %x) #0
  %1 = load i32* %x, align 4
  %2 = icmp eq i32 %1, 3
  br i1 %2, label %then, label %merge

then:                                             ; preds = %entry
  %3 = call i32 (i8*, i32*, ...)* bitcast (i32 (i8*, ...)* @scanf to i32 (i8*, i32*, ...)*)(i8* getelementptr inbounds ([3 x i8]* @"$string2", i64 0, i64 0), i32* %x) #0
  %4 = load i32* %x, align 4
  %5 = icmp eq i32 %4, 4
  br i1 %5, label %defer15, label %defer7

merge:                                            ; preds = %entry, %defer7
  %puts = call i32 @puts(i8* getelementptr inbounds ([3 x i8]* @str, i64 0, i64 0))
  %6 = call i32 (i8*, i32, ...)* bitcast (i32 (i8*, ...)* @printf to i32 (i8*, i32, ...)*)(i8* getelementptr inbounds ([4 x i8]* @"$string6", i64 0, i64 0), i32 4) #0
  %7 = call i32 (i8*, i32, ...)* bitcast (i32 (i8*, ...)* @printf to i32 (i8*, i32, ...)*)(i8* getelementptr inbounds ([4 x i8]* @"$string6", i64 0, i64 0), i32 3) #0
  ret i32 0

defer15:                                          ; preds = %then
  %puts14 = call i32 @puts(i8* getelementptr inbounds ([4 x i8]* @str9, i64 0, i64 0))
  %8 = call i32 (i8*, i32, ...)* bitcast (i32 (i8*, ...)* @printf to i32 (i8*, i32, ...)*)(i8* getelementptr inbounds ([4 x i8]* @"$string6", i64 0, i64 0), i32 3) #0
  ret i32 0

defer7:                                           ; preds = %then
  %puts12 = call i32 @puts(i8* getelementptr inbounds ([3 x i8]* @str7, i64 0, i64 0))
  %puts13 = call i32 @puts(i8* getelementptr inbounds ([4 x i8]* @str9, i64 0, i64 0))
  br label %merge
}
